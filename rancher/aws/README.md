...
Both instances are behind a restricted IP security group and will be accessible over SSH using the SSH keys
...
| [aws_security_group.rancher_sg](https://registry.terraform.io/providers/hashicorp/aws/5.1.0/docs/resources/security_group) | resource |
